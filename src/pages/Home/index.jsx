...
function Home() {
  return (
    <div className="min-h-screen bg-gray-100 text-gray-800">
      ...
      <section className="w-11/12 mx-auto lg:mb-16">
      ...
      <section className="mx-auto py-10 bg-gray-800 text-gray-100">
          ...
          <div className="flex flex-col justify-center">
            <div className="flex flex-col items-center space-x-4 sm:flex-row sm:justify-center sm:items-center">
              <ul className="text-center items-center sm:flex sm:justify-around sm:space-x-4 lg:flex-1">
                <li className="cursor-pointer hover:text-gray-600">Sobre</li>
                <li className="cursor-pointer hover:text-gray-600">Contatar</li>
                <li className="cursor-pointer hover:text-gray-600">Quero ser parceiro</li>
                <li className="cursor-pointer hover:text-gray-600">Quero me inscrever</li>
              </ul>
              <div className="flex gap-3">
                <a rel="noopener noreferrer" href="#" title="Instagram" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-blue-600 text-gray-200">
                ...
                <a rel="noopener noreferrer" href="#" title="Facebook" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-blue-600 text-gray-200">
                ...
                <a rel="noopener noreferrer" href="#" title="Gmail" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-blue-600 text-gray-200">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-4 h-4">
